...
public class CameraManager : MonoBehaviour {
	...
	public Animation battle_plane_behind_player_animation;
	...
	string exploration_camera_end_battle_name = "CameraExplorationEndBattle";
	...
	public IEnumerator COROUTINE_LaunchExplorationCameraEndBattleAnimation(float time = 1f)
	{
		yield return StartCoroutine(Coroutine_LaunchAnimation(exploration_camera_animation, exploration_camera_end_battle_name, time));
	}
	...
	public IEnumerator Coroutine_LaunchAnimation(Animation anim, string animation_name, float time)
	{
